...
import { createSipMaturityAction, deleteSipMaturityAction, getSipMaturityAction, getSipMaturityByIdAction, getSipPaidAmountAction, updateSipMaturityAction } from '../controllers/sipMaturity.controller.js';
...
sipMaturityRouter.get('/amount/:sip_id',Auth,getSipPaidAmountAction);
