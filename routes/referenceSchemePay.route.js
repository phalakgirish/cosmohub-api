...
import { createReferenceSchemePaymentAction, deleteReferenceSchPaymentAction, getReferenceSchemePaymentAction, getReferenceSchemePaymentByIdAction, referenceSchemePaymentDataCorrect, updateReferenceSchemePaymentAction } from '../controllers/referenceSchemePay.controller.js';
...
referenceSchemePayRouter.get('/all/correction',referenceSchemePaymentDataCorrect);
